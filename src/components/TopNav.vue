  ...
  <header class="absolute inset-x-0 top-0 z-50 shadow">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <router-link to="/" class="text-sm font-semibold leading-6 text-gray-900 cursor-pointer">Home</router-link>
        <router-link to="/component-list" class="text-sm font-semibold leading-6 text-gray-900 cursor-pointer">Component
          list</router-link>
      </div>
